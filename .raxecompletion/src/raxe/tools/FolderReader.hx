package src.raxe.tools;using Lambda;using StringTools;import sys.FileSystem;
import sys.io.File;
 ...
 **/
static dynamic public function createFile(path : String, ?content : String) : Void{
 ...
 **/
static dynamic public function createDirectory(path : String) : Void{
  var parts : Array<String> = path.split("/");
